<template>
  <div class='key-container'>
    <div class='keyboard' :class="money==''? 'height':' heights'" @click.stop='_handleKeyPress'>
      <!--<div class="upordown" :class="showkey?'position':'pos'" @click.stop="goup()">-->
        <!--<div class="up"></div>-->
        <!--<div class="down"></div>-->
      <!--</div>-->
      <div class="showkey" v-show="showkey">
        <div class='input-box' v-show="money.length>0" @click.stop="nones()">{{ money }}</div>
        <div style="overflow: hidden;">
          ...
          <div class='key-row'>
            ...
            <div class='' id="mydelete" data-num='D'></div>
            <div class='key-cell' data-num='-1'>c</div>
          </div>
          <div class='key-confirm' data-num='S'>完成</div>
        </div>
      </div>
    </div>
  </div>
...
//        return this.changecount + '-' + this.lastname
//      }
//    },
    methods : {
      nones(){},
...
<style scoped>
  ...
  .down{
    width: 0.36rem;
    height:0.26rem;
    background: url("../../../assets/jpgs/jiantou.jpg") no-repeat;
  ...
  #mydelete{
    ...
    text-align: center;
    position: relative;
    background:white url("../../../assets/jpgs/delete.png") no-repeat;
